...
```
# Site settings
title: HD Blog                    # 你的博客网站标题
SEOTitle: HD的博客 | HD Blog		# SEO 标题
description: "Hey"	   	   # 随便说点，描述一下

# SNS settings      
github_username: wanghaodi     # 你的github账号
jianshu_username: afdfc22584c9  # 你的简书ID。
...
看右边:
![](https://raw.githubusercontent.com/wanghaodi/wanghaodi.github.io/master/img/readme-side.png)
...
sidebar-avatar: /img/cat1.jpg     #你的大头贴，请使用绝对地址.注意：名字区分大小写！后缀名也是
```
...
friends: [
    {
        title: "HD Blog",
        href: "https://wanghaodi.github.io/"
    },
    {
        title: "Apple",
...
参考我的这篇文章：[《为博客添加 Gitalk 评论插件》](http://wanghaodi.top/2017/12/19/%E4%B8%BA%E5%8D%9A%E5%AE%A2%E6%B7%BB%E5%8A%A0-Gitalk-%E8%AF%84%E8%AE%BA%E6%8F%92%E4%BB%B6/)
...
我的博客标题是 **HD Blog”** 但是我想要在搜索的时候显示 **“HD的博客 | HD Blog”** ，这个就需要 SEO Title 来定义了。
